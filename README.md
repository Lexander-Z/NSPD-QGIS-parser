...
ВНИМАНИЕ! Для того, чтобы воспользоваться скриптом необходимо установить сертификаты Минцифры, а затем перезагрузить ПК!
...
12. Нажимаем на необходимый участок для выгрузки
   ...
   Вся информация будет заполнена в атрибутивной таблице
